...
public class OptionalModifierType : TypeSpecification
{
	...
	public override MetadataType MetadataType => MetadataType.OptionalModifier;
	...
	internal OptionalModifierType(TypeReference modifierType, TypeReference elementType, TypeContext context)
