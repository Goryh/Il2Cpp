...
public class WriteGenericsPseudoCodeGenModule : SimpleScheduledStep<GlobalWriteContext>
{
	...
	{
		PerAssemblyCodeMetadataWriter.WriteGenericsPseudoCodeGenModule(context.CreateSourceWritingContext(), _cleanName, MetadataUtils.RegistrationTableName(context.GetReadOnlyContext()), CodeRegistrationWriter.CodeRegistrationTableName(context.GetReadOnlyContext()));
	}
}
