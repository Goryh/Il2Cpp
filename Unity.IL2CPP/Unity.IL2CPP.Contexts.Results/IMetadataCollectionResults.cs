...
public interface IMetadataCollectionResults
{
	...
	ReadOnlyCollection<VTableSlot> GetVTableMethods();

	ReadOnlyCollection<InterfaceOffset> GetInterfaceOffsets();

	ReadOnlyCollection<TypeReference> GetExportedTypes();
	...
	int GetLowestExportedTypeIndexForModule(ModuleDefinition image);
}
