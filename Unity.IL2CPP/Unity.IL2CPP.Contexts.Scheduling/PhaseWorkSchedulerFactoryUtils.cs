...
{
	public static ForkedContextScope<int, GlobalWriteContext> ForkForPrimaryWrite(GlobalWriteContext context, OverrideObjects overrideObjects, int count)
	{
		return context.ForkFor((IUnrestrictedContextDataProvider parent) => CreateScopeForPrimaryWrite(parent, count, overrideObjects));
	}

	public static ForkedContextScope<int, GlobalPrimaryCollectionContext> ForkForPrimaryCollection(GlobalPrimaryCollectionContext context, OverrideObjects overrideObjects, int count)
	{
		return context.ForkFor((IUnrestrictedContextDataProvider parent) => CreateScopeForPrimaryCollection(parent, count, overrideObjects));
	}

	public static ForkedContextScope<int, GlobalSecondaryCollectionContext> ForkForSecondaryCollection(GlobalSecondaryCollectionContext context, OverrideObjects overrideObjects, int count)
	{
		return context.ForkFor((IUnrestrictedContextDataProvider parent) => CreateScopeForSecondaryCollection(parent, count, overrideObjects));
	}

	public static ForkedContextScope<int, GlobalWriteContext> ForkForSecondaryWrite(GlobalWriteContext context, OverrideObjects overrideObjects, int count)
	{
		return context.ForkFor((IUnrestrictedContextDataProvider parent) => CreateScopeForSecondaryWrite(parent, count, overrideObjects));
	}
