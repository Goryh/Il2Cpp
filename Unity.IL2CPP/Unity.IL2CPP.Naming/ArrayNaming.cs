...
{
	public static string ForRuntimeArrayType(this INamingService naming, ReadOnlyContext context, Il2CppArrayRuntimeType type)
	{
		return naming.ForIl2CppType(context, type) + "_ArrayType";
	}
